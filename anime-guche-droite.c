...
SDL_SetColorKey(p[4],SDL_SRCCOLORKEY,SDL_MapRGB(p[4]->format,255,255,255));
SDL_SetColorKey(p[5],SDL_SRCCOLORKEY,SDL_MapRGB(p[5]->format,255,255,255));
SDL_SetColorKey(p[6],SDL_SRCCOLORKEY,SDL_MapRGB(p[6]->format,255,255,255));
SDL_SetColorKey(p[7],SDL_SRCCOLORKEY,SDL_MapRGB(p[7]->format,255,255,255));
